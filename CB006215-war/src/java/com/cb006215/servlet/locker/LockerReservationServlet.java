 ...
 * @author ravi
 */
public class LockerReservationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             System.out.println("Servlet->LockerReservationServlet");
            /* TODO output your page here. You may use following sample code. */
            ...
            if (deAmount.compareTo(ticket.getBalance()) < 0) {
                ...
                custlockercb006215Facade.setLocker(type, ticket.getBcn(), deAmount);
                ...
                paymentcb006215Facade.setPayment(ticket.getBcn(),
                        deAmount, "E-Locker", "Locker Purchase", "", "");
                //--//add payment record
                
                                request.setAttribute("msg", "<p class=\"bg-success\">Locker reservation successful</p>");
